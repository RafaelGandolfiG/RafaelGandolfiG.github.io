...
function parimpar(){
    ...
    if(numero===''){
        alert('Voce nao digitou nenhum numero');
        return
    }
    numero=parseFloat(numero);
    if (numero%2!=0){
        epar=false;
        document.getElementById('res').innerHTML=`O numero ${numero} e impar`;
    }
    else{
        document.getElementById('res').innerHTML=`O numero ${numero} e par`;
    }
}
...
function maior2(){
    ...
    if (numerosex8.length===0){
        ...
        document.getElementById('re').innerHTML+='<br>O menor numero eh: '+maior;
    }
}
